...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/ali_kazim19/profilecard/?igsh=MWIzMmswMmZ5OHI4OQ==","_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/kazim-ali-723999202/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/alikazim1", "_blank");
    }
    if (x == 4) {
        window.open("", "_blank");
    }
